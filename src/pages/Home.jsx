...
import { ArrowRight, Code2, Layers, Server, Wrench, Brain } from "lucide-react";
...
const ROLES = ["MERN Stack Developer", "Full-Stack JavaScript Developer", "AI/ML Enthusiast"];
  ...
  return (
    <div className="card overflow-hidden" style={{ background: "var(--bg-inset-dark)", borderColor: "transparent" }}>
      ...
      <div className="p-5 text-[13px] leading-7 overflow-x-auto" style={{ fontFamily: "var(--font-mono)", color: "var(--text-on-dark)" }}>
        ...
        <CodeLine n={5}>
          {"  "}{key("stacks")}{punct(":")} {punct("[")}{str("React")}{punct(",")} {str("Node.js")}{punct(",")} {str("MongoDB")}{punct("]")}{punct(",")}
        </CodeLine>
...
function ProfilePhoto() {
  return (
    <div className="relative w-56 h-56 md:w-72 md:h-72 mx-auto">
      ...
      <FloatingBadge icon={Code2} label="React" color="var(--tok-frontend)" className="-top-2 -left-4 md:-left-8" delay={0} />
      <FloatingBadge icon={Server} label="Node.js" color="var(--tok-data)" className="top-1/3 -right-6 md:-right-10" delay={0.6} />
...
const skillGroups = [
  ...
  },
  {
    ...
    color: "var(--tok-tools)",
    icon: Layers,
    items: ["React", "Redux", "HTML5 / CSS3", "Tailwind CSS"],
  },
  {
    title: "Backend",
  ...
  },
  {
    ...
    color: "var(--tok-data)",
    icon: Wrench,
    items: ["Git & GitHub", "Mongoose", "OOP & DSA", "Postman", "AWS basics"],
  },
];
        ...
        <div className="grid md:grid-cols-[1.1fr_0.9fr] gap-14 md:gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg" style={{ color: "var(--text-secondary)", maxWidth: "34rem" }}>
              A Software Engineering graduate building full-stack web apps with the{" "}
              <span style={{ color: "var(--text-primary)", fontWeight: 600 }}>MERN stack</span>, with a growing
              interest in{" "}
          ...
          <div className="grid md:grid-cols-[1.1fr_0.9fr] gap-8 items-start">
            <div>
              <p className="leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                ...
                Rawalpindi. I build full-stack web apps with the{" "}
                <span style={{ color: "var(--text-primary)", fontWeight: 600 }}>MERN stack</span> — React on the
                frontend, Node.js and Express powering the backend, and MongoDB for data — and I'm comfortable
                across the full stack, from designing REST APIs and handling auth to shipping a responsive UI.
                I'm a fresher with no formal industry experience yet, which is exactly why I'm looking for new
                opportunities: a place to apply what I've built on my own, and learn the rest from people doing
                it for real.
              </p>
